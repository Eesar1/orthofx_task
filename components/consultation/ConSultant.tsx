    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full relative z-10 px-4 md:px-6">
        ...
        <div className="flex flex-col justify-center">
          ...
          {/* Main Heading */}
          <h2 className="text-white text-3xl font-light sm:text-4xl lg:text-5xl  leading-[1.2] max-w-md mb-6">
        ...
        <div className="flex flex-col items-center lg:items-start gap-8 pt-14">
          {steps.map(({ step, title, desc }) => (
            <div
              key={step}
              className="bg-white/80 border font-light border-gray-200 rounded-3xl mr-auto p-6 shadow-lg transition duration-300 min-h-[200px] w-full max-w-[300px] flex flex-col justify-between backdrop-blur-sm"
            >
              <div className="text-black text-lg font-light font-liBaskerville mb-1">
                Step {step}
              </div>
              <h3 className="text-black font-grostek  text-[22px] leading-tight mb-2">
                {title}
              </h3>
